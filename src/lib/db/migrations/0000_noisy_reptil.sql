...
CREATE UNIQUE INDEX "budgets_user_month_year_idx" ON "budgets" USING btree ("user_id","month","year");--> statement-breakpoint
...
CREATE INDEX "recurring_rules_next_due_idx" ON "recurring_rules" USING btree ("next_due_date","is_active");--> statement-breakpoint
CREATE INDEX "transactions_user_date_idx" ON "transactions" USING btree ("user_id","date");--> statement-breakpoint
CREATE UNIQUE INDEX "transactions_import_hash_idx" ON "transactions" USING btree ("user_id","import_hash");